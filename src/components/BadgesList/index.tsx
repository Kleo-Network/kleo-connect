      ...
      <div className="flex flex-col self-stretch rounded-lg border border-gray-400 w-2/3 mx-auto my-8">
        ...
        <div className="flex flex-col justify-center items-center self-stretch m-6 h-1/3 bg-violet-200 border border-2 border-violet-600 rounded-lg">
          <div className="flex flex-col md:flex-row justify-self-center items-center self-stretch m-2 md:m-6 p-2 ">
            <div className="flex flex-col justify-center items-center w-1/3">
              ...
              />
              <span className="font-normal mt-2"> Unlocked </span>
            </div>
            ...
            <span className="mx-8 md:mx-16 text-l font-normal md:w-1/3">
              This allows them to mint an NFT! We are giving away Bonk tokens
              for being active on our platform. The NFT PFP itself will have a
              small Bonk dog logo along with your profile image! This offer is
              only valid for the first 1000 users.
            </span>
        ...
        <div className="flex flex-col justify-center items-center self-stretch m-6 h-1/3 bg-violet-200 border border-2 border-violet-600 rounded-lg h-1/3">
          <div className="flex flex-col md:flex-row justify-self-center items-center self-stretch m-6 p-2">
            ...
            <span className="mx-8 md:mx-16 text-l font-normal md:w-1/3">
              For users active for 15 days on Kleo, they can compare two
              different profiles and find data consumption similarities and
              differences. The first 1000 users to unlock this will get some
              extra BONK as well!
            </span>
            <input
              className="rounded-full"
        ...
        <div className={`relative ${true ? 'pointer-events-none' : ''}`}>
          ...
          <div className="flex flex-col justify-center items-center self-stretch m-6 h-1/3 bg-white border border-2 border-violet-600 rounded-lg h-1/3">
            <div className="flex flex-col md:flex-row justify-self-center items-center self-stretch m-6 p-2">
              ...
              <span className="mx-8 md:mx-16 text-l font-normal md:w-1/3 ">
                Find and match with people on Kleo having a similar data
                identity as you do! Using a different key (account abstraction),
                this will ensure you remain anonymous. The first 30 topics to
                form communities will get some BONK drops.
              </span>
            </div>
          </div>
        </div>
