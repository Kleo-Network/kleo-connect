...
export const MediaBanner = () => {
  ...
  const titles = ['Airdrop Seasons', 'Kleo Connect']

  const description = [
    'Create Account to receive 10,000 $VANA. Secure your reward and <br /> unlock new possibilities.',
  ...
  return (
    <div className="relative w-full h-full">
      <div className="absolute bottom-[10%] left-[4%] z-50">
        <h1 className="text-white pb-2 text-3xl">{titles[activeIndex]}</h1>
