...
const Referrals = ({ userAddress }: ReferralsProps) => {
  ...
  return (
    <>
      ...
      {!isLoading && (
        <div className="container flex flex-col justify-start mx-auto p-5 bg-white rounded-xl h-full gap-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <div className="flex items-center space-x-1 rounded-full bg-gray-100 px-2 py-2">
                ...
                <p className="text-[9px] md:text-xs font-inter whitespace-nowrap">
              ...
              <div className="w-full h-full flex flex-col gap-5 items-center justify-center">
                ...
                <div className="text-center w-1/2">
                  ...
                  <p className="text-[#667085] text-sm">
                    Share the link with your friends, and when they sign up on
                    KLEO you will earn XPs.
                  </p>
                </div>
              </div>
            ) : (
