...
const DataQuality = ({
  ...
  const [radarChartData, setRadarChartData] =
    useState<RadarChartDataset>(RadarChartData)
    ...
    <div className="flex flex-col justify-between bg-white p-5 rounded-xl h-full">
      <div className="flex flex-col justify-start h-full gap-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="w-5/6 font-inter text-sm">
              Data quality score is based on{' '}
              <a
                href="https://docs.kleo.network/kleo_network/rewards/"
                target="_blank"
              >
                <u className="text-[#7f56d9]">uniqueness</u>
              </a>{' '}
              of your activity.
            </p>
          </div>
        ...
        {isProcessing && !isLoading && (
          <div className="w-full bg-[#F2F4F7] rounded-lg overflow-hidden flex items-center justify-center flex-1">
            <ProcessingMessage />
          </div>
        )}
                ...
                {isLoading ? (
                  ...
                  <>
                    <span className="font-bold">
                      {highestValue !== -1 ? highestValue + '%' : 'N/A'}{' '}
                    </span>
