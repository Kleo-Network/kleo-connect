  ...
  return (
    <li
      className={`flex items-center justify-between p-4 bg-gray-100 rounded-lg cursor-pointer ${
        completed ? 'opacity-50 pointer-events-none' : 'hover:bg-gray-200'
      }`}
    ...
    >
      ...
      <span className="text-[#7f56d9] font-bold bg-white w-24 h-8 rounded-full flex items-center justify-center relative">
        ...
        {completed && (
          <span className="absolute top-[-4px] right-[-4px] bg-green-500 text-white text-xs w-4 h-4 rounded-full flex items-center justify-center">
            ✓
          </span>
        )}
      </span>
